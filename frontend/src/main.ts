...
import { getIntoIDE } from './views/GetIntoIDE';
...
// 1️⃣ Montamos el layout VSCode
getIntoIDE();

// 2️⃣ Este será el contenedor del router
const page = document.getElementById('router-view')!;
