...
** randomColorHex
**
** Generates a readable random HEX color.
** Used for autogenerated avatars.
*/
...
export async function renderPlay1v1(root: HTMLElement): Promise<void> 
{
  ...
  startBtn?.addEventListener('click', () => 
  {
    ...
    logTerminal(`Starting 1v1: ${me.nick} vs ${p2Now.nick}`);
    ...
    <section class="mx-auto max-w-6xl p-6 grow space-y-6 text-white">
      ...
      <div class="flex justify-center p-4">
        <canvas id="live_pong"
                ...
                class="border-4 border-white rounded-2xl shadow-xl">
        </canvas>
      </div>
    </section>
  `;
